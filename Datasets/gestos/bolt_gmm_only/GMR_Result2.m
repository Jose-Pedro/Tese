function [GMR_Data , GMR_Sigma]=GMM_Result2(joint_number,Data,N_Clusters,printflag)
%% 
% Inputs:
...
for n=1:nbVar-1
    ...
    title(['Concatenated signature  from the joint number ' num2str(joint_number)],'fontsize',14);
    grid on
    axis ([0 x_size/10 -2.5 2.5]);
