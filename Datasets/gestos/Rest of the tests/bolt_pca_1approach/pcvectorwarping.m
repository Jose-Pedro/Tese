...
% In a first approach after vectors warping was decided to resize them again to the size of smallest
% sized vector .
...
title('DTW -  Resized Principal component data warped to the reference (mean vector) and resized after time warp. ');
grid on 
axis ([0 T -2.5 2.5]);
