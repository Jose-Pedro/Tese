function Data=vectorwarping(pc1,pc2,pc3,pc4,pc5,pc6,g1,g2,g3,g4,g5,g6,joint,printflag)
...
% vectors or not(if not just comment this line)
 str = sprintf('Joint number  %i. ',joint);
if printflag
    printingFunction(aux*100/10^3,vector1_pc_w,vector2_pc_w,vector3_pc_w,vector4_pc_w,vector5_pc_w,vector6_pc_w,'Data after Dynamic time Warp ','Data after Dynamic time warping ',str,'Time - 100ms each point',1,g1,g2,g3,g4,g5,g6);
end
clearvars aux
...
if printflag
    ...
    printingFunction(T,vector1_pc_w,vector2_pc_w,vector3_pc_w,vector4_pc_w,vector5_pc_w,vector6_pc_w,'Data Warping after DTW and Resize','Data after time warping and resizing in the end',str,'Time - 100ms each point',1,g1,g2,g3,g4,g5,g6);
end
