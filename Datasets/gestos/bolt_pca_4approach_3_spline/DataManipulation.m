...
%  evaluate
time=zeros(100,12);
Signature=zeros(54,12);
for joint_number=1:12

Data=vectorwarping(Data1(:,joint_number),Data2(:,joint_number),Data3(:,joint_number),Data4(:,joint_number),Data5(:,1),Data6(:,joint_number),1,g1,g2,g3,g4,g5,g6);

[GMR_Data , GMR_Sigma]=GMM_Result(joint_number,Data,5,1,Data1,Data2,Data3,Data4,Data5,Data6,g1,g2,g3,g4,g5,g6); 
time(:,joint_number)=GMR_Data(1,:);

A=resizeVector(GMR_Data,54);
Signature(:,joint_number)=A(2,:);
end


fileID = fopen('signature_withoutPCA.txt','w');
for i=1:54
